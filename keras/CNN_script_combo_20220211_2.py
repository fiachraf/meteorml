...
detectpixel_input =keras.Input(shape=(256,256,1))
maxframe_input = keras.Input(shape=(256,256,1))
...
x_frame = layers.Dropout(.1)(x_frame)
x_frame = layers.Conv2D(32, (3,3), activation="relu")(x_frame)
x_frame = layers.MaxPooling2D((2,2))(x_frame)
x_frame = layers.Dropout(.1)(x_frame)
#x_frame = layers.Conv2D(64, (3,3), activation="relu")(x_frame)
#x_frame = layers.MaxPooling2D((2,2))(x_frame)
x_frame = layers.Flatten()(x_frame)
x_frame = layers.Dense(128, activation="relu")(x_frame)
x_frame = layers.Dense(64, activation="selu")(x_frame)
...
y_frame = layers.Dropout(.1)(y_frame)
y_frame = layers.Conv2D(32, (3,3), activation="relu")(y_frame)
y_frame = layers.MaxPooling2D((2,2))(y_frame)
y_frame = layers.Dropout(.1)(y_frame)
#y_frame = layers.Conv2D(64, (3,3), activation="relu")(y_frame)
#y_frame = layers.MaxPooling2D((2,2))(y_frame)
y_frame = layers.Flatten()(y_frame)
y_frame = layers.Dense(128, activation="relu")(y_frame)
x_frame = layers.Dense(64, activation="selu")(x_frame)

#need to combine the two frameworks
concat_layer = layers.Concatenate()([x_frame, y_frame])

combo_layer = layers.Dense(128, activation="relu")(concat_layer)
combo_layer = layers.Dropout(.1)(combo_layer)
