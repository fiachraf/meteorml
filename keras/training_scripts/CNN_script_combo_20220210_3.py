...
x_frame = layers.Conv2D(32, (3,3), activation="relu")(detectpixel_input)
...
y_frame = layers.Conv2D(32, (3,3), activation="relu")(maxframe_input)
...
model.compile(loss="binary_crossentropy", optimizer=optimizers.Adam(epsilon=0.1, learning_rate=0.0001), metrics=["acc"])
